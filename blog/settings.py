...
#MailChimp
MAILCHIMP_API_KEY = os.environ.get("mailchimp_apki_key")
MAILCHIMP_DATA_CENTER = os.environ.get("mailchimp_dc")
MAILCHIMP_EMAIL_LIST_ID = os.environ.get("mailchimp_emailList")
